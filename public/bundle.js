...
const Header_1 = __webpack_require__(/*! ./components/Header */ "./components/Header.tsx");
...
class Content extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null, products.map((user) => {
...
var _Root = __webpack_require__(/*! ./Root */ "./Root.tsx");
...
var App = function App() {
    return _react2.default.createElement(
        ...
        { store: store },
        _react2.default.createElement(_Root2.default, { compiler: 'TypeScript', framework: 'React' })
    );
};
...
var fetchProducts = exports.fetchProducts = function fetchProducts() {
    return function (dispatch) {
        ...
        return _axios2.default.get('https://accounts.spotify.com/authorize', {
            params: {
...
exports.default = (0, _redux.combineReducers)({ products: _productReducer2.default });
